        ...
        get() {
            ...
            xhr.onload = function () {
                if (xhr.status === 200) {
                    ...
                    let seaData = data[0].seaLevelFromSatellitesInches;
                    console.log(seaData);
                    ...
                    Sea.push(new Seawater('rgb(11, 127, 171', seaData));*/
...
class Seawater {
    constructor(color, radius) {
        this.radius = radius /*(Math.random() * 150) + 200*/;
        this.life = true;
        this.x = (Math.random() * window.innerWidth);
        this.y = (Math.random() * 20) + window.innerHeight + this.radius;
        this.vy = ((Math.random() * 0.001) + 0);
        this.vr = 0;
...
*//*        this.vy += 0.00001;
    ...
    draw(currentCanvas2) {
        ...
        currentCanvas2.arc(window.innerWidth / 2, 2*window.innerHeight / 3, this.radius, 0, 2 * Math.PI);
